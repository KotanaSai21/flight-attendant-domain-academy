...
export const dictionary: DictionaryTerm[] = [
  ...
  },
  {
    ...
    definition: 'A completion view focused on cancellations attributed to controllable causes; the exact AA calculation and exclusions require current verification.',
    businessPurpose: 'Separates controllable completion outcomes from the broader completion measure.',
    whyItMatters: 'Reason-code ownership and metric governance affect the result.',
    whereUsed: ['Operational performance', 'Controllable-cause analysis'],
    example: 'A cancellation reason may be classified differently from weather or air-traffic constraints.',
